  ...
  return (
    <div className="relative flex h-[50vh] items-center justify-center bg-transparent antialiased md:h-[60vh]">
      <button
        ...
        className="group relative z-40 inline-block h-[120px] rounded-full bg-slate-800 p-px text-xs font-semibold leading-6 no-underline shadow-2xl shadow-zinc-900  dark:text-white lg:w-[320px]"
      >
  ...
  return (
    <div className="relative  flex flex-shrink-0 ">
      ...
      <button
        ...
        className="absolute left-[80px] top-[420px] animate-pulse cursor-pointer   md:left-[110px]"
      >
        <a
        ...
        >
          <svg
            ...
            height="64"
            viewBox="0 0 16 16"
            className="fill-neutral-900 hover:fill-neutral-700 dark:fill-neutral-400 dark:hover:fill-neutral-50"
          >
      ...
      >
        <a href="mailto:krystian.grala97@gmail.com" aria-label="Send me email">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="84"
            height="84"
